...
export default function BoutiqueHero() {
  ...
  return (
    <section id="accueil" className="relative">
      {/* HERO */}
      <section
        className="relative min-h-[80vh] flex items-center justify-center overflow-hidden rounded-b-[3rem]"
        style={
          isDark
            ? { background: 'linear-gradient(135deg,#0f766e 0%,#134e4a 50%,#020617 100%)' }
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl py-32">
          ...
          <h1 className="font-serif text-5xl md:text-8xl font-normal text-white leading-[0.85] tracking-tighter mb-8">
            Catalogue
            <br />
            <em className="text-brand-300">Produits</em>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#catalogue"
              className="px-8 py-4 rounded-2xl text-sm font-bold uppercase tracking-wide transition-all duration-300 hover:scale-105"
              style={{
                background: '#fff',
                color: 'var(--brand-700)',
