  ...
  return (
    <nav className="nav-glass fixed top-0 left-0 right-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        <Link href="/" className="flex items-center group" aria-label="EAUMALIK Accueil">
          <Image
            src="/logo.png"
            alt="EAUMALIK"
            width={2038}
            ...
            priority
            unoptimized
            className="h-7 w-auto sm:h-8 drop-shadow-sm transition-transform group-hover:scale-105"
          />
        </Link>
